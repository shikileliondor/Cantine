<div class="space-y-6">
    <section class="rounded-3xl border border-slate-200 bg-white/80 p-6 dark:border-slate-800 dark:bg-slate-900/60">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <button wire:click="ajouterTarif" type="button" class="rounded-2xl border border-emerald-500/40 bg-emerald-500/20 px-4 py-2 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-500/30 dark:text-emerald-200">
                Nouveau tarif
            </button>
        </div>
    </section>
