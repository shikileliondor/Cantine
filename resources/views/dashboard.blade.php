<x-app-layout>
  ...
  <div class="space-y-8">
    <section class="grid gap-6 lg:grid-cols-3">
      <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-6 shadow-xl shadow-slate-950/40">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
          <span class="rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-300">Paiements à jour</span>
          <span class="rounded-full bg-amber-500/20 px-3 py-1 text-xs font-semibold text-amber-600 dark:text-amber-300">Factures partielles</span>
          <span class="rounded-full bg-rose-500/20 px-3 py-1 text-xs font-semibold text-rose-600 dark:text-rose-300">Relances en retard</span>
        </div>
      </div>
      <div class="grid gap-6 sm:grid-cols-2 lg:col-span-2">
        <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-5">
          <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Encaissements</p>
          <p class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">24 560 000 XOF</p>
        ...
        <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-5">
          ...
          <p class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">1 280</p>
          <p class="mt-1 text-sm text-sky-600 dark:text-sky-300">98% générées</p>
        </div>
        <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-5">
          <p class="text-xs uppercase tracking-[0.2em] text-slate-500">Retards</p>
          <p class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">74 factures</p>
        ...
        <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-5">
          ...
          <p class="mt-3 text-2xl font-semibold text-slate-900 dark:text-white">18 dossiers</p>
          <p class="mt-1 text-sm text-amber-600 dark:text-amber-300">Paramètre activé</p>
        </div>
      </div>
    </section>
    ...
    <section class="grid gap-6 xl:grid-cols-3">
      ...
      <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-6 xl:col-span-2">
        <div class="flex items-center justify-between">
          ...
          <span class="rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-300">
    ...
    <section class="grid gap-6 lg:grid-cols-2">
      <div class="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white/90 dark:bg-slate-900/70 p-6">
        <div class="flex items-center justify-between">
          <h3 class="text-lg font-semibold text-slate-900 dark:text-white">Derniers paiements</h3>
          <a href="#" class="text-sm font-semibold text-emerald-600 dark:text-emerald-300">Voir tout</a>
        </div>
        <div class="mt-6 space-y-4 text-sm text-slate-600 dark:text-slate-300">
          <div class="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-slate-950/60 px-4 py-3">
            <div>
              <p class="font-semibold text-slate-900 dark:text-white">Ndiaye Awa</p>
              <p class="text-xs text-slate-500">Classe CM2 · 10 000 XOF</p>
            </div>
            <span class="rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-300">Payé</span>
          </div>
          <div class="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-slate-950/60 px-4 py-3">
            <div>
              <p class="font-semibold text-slate-900 dark:text-white">Diallo Ibrahima</p>
              <p class="text-xs text-slate-500">Classe CE1 · 6 000 XOF</p>
            </div>
            <span class="rounded-full bg-amber-500/20 px-3 py-1 text-xs font-semibold text-amber-600 dark:text-amber-300">Partiel</span>
          </div>
          <div class="flex items-center justify-between rounded-2xl bg-slate-50 dark:bg-slate-950/60 px-4 py-3">
            <div>
              <p class="font-semibold text-slate-900 dark:text-white">Koné Mariatou</p>
